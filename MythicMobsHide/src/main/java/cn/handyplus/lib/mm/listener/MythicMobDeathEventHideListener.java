package cn.handyplus.lib.mm.listener;

import cn.handyplus.lib.mm.event.MythicMobLibDeathEvent;
 ...
 * @since 1.0.1
 */
public class MythicMobDeathEventHideListener implements Listener {
